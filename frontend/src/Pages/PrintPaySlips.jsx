...
import { dummyPayslipData } from '../assets/dummydata';
...
function PrintPaySlips() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-8 bg-white animate-fade-in">
      ...
      <div className='rounded-x1 border border-slate-200 overflow-hidden mb-8'>
        <table className="w-full text-sm">
          ...
          <tbody>
            ...
            <tr className="border-t-2 border-slate-200 bg-slate-50">
              <td className='py-4 px-4 font-bold text-slate-700'>Net Salary</td>

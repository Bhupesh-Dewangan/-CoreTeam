...
function Sidebar() {
  ...
  useEffect(() => {
    // When route changes, close the mobile sidebar.
    ...
    <>
      ...
      <div className="px-5 pt-6 pb-5 border-b border-white/6">
        <div className="flex items-center justify-between">
          ...
          <button
            className="text-slate-400 hover:text-white size-6 lg:hidden p-1"
      ...
      <div className="p-3 border-t border-white/6">
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-md text-[13px] font-medium text-slate-400 hover:text-rose-400 hover:bg-rose-500/8 transition-all duration-150"
        >

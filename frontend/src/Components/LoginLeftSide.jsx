...
function LoginLeftSide() {
  return (
    <div className="hidden h-screen md:flex w-1/2 bg-indigo-950 relative overflow-hidden border-r border-slate-200">
      ...
      <div className="relative z-10 flex flex-col items-start justify-center p-12 lg:p-20 w-full h-full">
        ...
        <p className="text-slate-400 text-lg max-w-md leading-relaxed">
          Stremline your workforce operations, track attendance, and manage
